...
* Удалить сообщение и уведомить пользователя в ЛС о причине.
...
* **NSFW (ИИ):** Нейросеть автоматически обнаруживает и блокирует изображения для взрослых, анализируя не только загруженные файлы, но и картинки по ссылкам.
* **Токсичность (ИИ):** Уникальная система, анализирующая контекст, а не просто ключевые слова. Эффективно выявляет оскорбления, угрозы и скрытый негатив, даже если они замаскированы.
...
1. **Общие настройки:** Здесь вы можете указать канал для логов автомодерации, роль для пинга, а также глобальные исключения (роли, каналы, **категории** и **конкретные пользователи**, на которые автомодератор не будет действовать).
