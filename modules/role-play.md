...
* Укусить
* Дать пять
* **💕 Нежный поцелуй** (только для партнёров)
* **💕 Танец** (только для партнёров)
...
* **Эксклюзивные действия:** Некоторые действия, отмеченные 💕, доступны только для вашего партнера по браку.
